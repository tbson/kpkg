...
describe('CategoryTable component', () => {
    ...
    it('Init data', done => {
        const wrapper = shallow(<CategoryTable match={match} />);
    ...
    it('Check all', () => {
        ...
        const wrapper = shallow(<CategoryTable match={match} list={seeding(10)} />);
        const instance = wrapper.instance();
...
describe('CategoryTable methods', () => {
    ...
    describe('getSearchList', () => {
        ...
        it('Empty string', async () => {
            ...
            // Init component
            const wrapper = shallow(<CategoryTable />);
            const instance = wrapper.instance();
    ...
    describe('onSubmitSuccess', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(CategoryTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<CategoryTable match={match} list={list} />);
            instance = wrapper.instance();
        });
