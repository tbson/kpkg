...
import {Row, CategoryTable} from '../tables/CategoryTable';
import LoadingLabel from 'src/utils/components/LoadingLabel';
import Tools from 'src/utils/helpers/Tools';

Enzyme.categoryure({adapter: new Adapter()});
...
describe('CategoryTable component', () => {
    ...
    it('Get list', done => {
        ...
        setTimeout(() => {
            ...
            expect(props.action.mock.calls[0][1]).toEqual({
                data: props.categoryState.list,
                pages: props.categoryState.pages,
            });
    ...
    it('Add', done => {
        ...
        const toggleModalSpy = jest.spyOn(CategoryTable.prototype, 'toggleModal');
    ...
    describe('Bulk remove', () => {
        ...
        it('No check', done => {
            const handleRemoveSpy = jest.spyOn(CategoryTable.prototype, 'handleRemove').mockImplementation(() => null);
        ...
        it('Check 1', done => {
            props.categoryState.list[0].checked = true;
        ...
        it('Check 3', done => {
            props.categoryState.list[0].checked = true;
            props.categoryState.list[1].checked = true;
            props.categoryState.list[2].checked = true;
    ...
    describe('CategoryTable methods', () => {
        afterEach(() => {
            jest.restoreAllMocks();
        });
        ...
        it('list', async () => {
            ...
            const setInitDataSpy = jest.spyOn(CategoryTable.prototype, 'setInitData');
            ...
            expect(apiCallSpy.mock.calls[0][0]).toEqual('about:///api/v1/category/');
            ...
            // Default URL
            expect(apiCallSpy).toHaveBeenCalled();
            expect(apiCallSpy.mock.calls[1][0]).toEqual('about:///api/v1/category/');
        ...
        describe('toggleModal', () => {
            it('Not defined modalName or null ID', async () => {
                ...
                jest.spyOn(CategoryTable.prototype, 'componentDidMount').mockImplementation(() => {});
                ...
                let wrapper = shallow(<CategoryTable {...props} />);
        ...
        it('handleSubmit', async () => {
            ...
            const toggleModal = jest.spyOn(CategoryTable.prototype, 'toggleModal')
                .mockImplementation(
                    () => ({}),
                );
            jest.spyOn(CategoryTable.prototype, 'componentDidMount').mockImplementation(() => {});
            ...
            const handleAddSuccess = jest.spyOn(CategoryTable.prototype, 'handleAdd')
                .mockImplementation(
                    async params => null
                );
            const handleEditSuccess = jest.spyOn(CategoryTable.prototype, 'handleEdit')
                .mockImplementation(
                    async params => null
                );
