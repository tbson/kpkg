...
describe('StaffTable component', () => {
    ...
    it('Init data', done => {
        const wrapper = shallow(<StaffTable />);
    ...
    it('Check all', () => {
        ...
        const wrapper = shallow(<StaffTable list={seeding(10)} />);
        const instance = wrapper.instance();
...
describe('StaffTable methods', () => {
    ...
    describe('getList', () => {
        it('fail', async () => {
            ...
            expect(getList.mock.calls[0][0]).toEqual('http://localhost/api/v1/staff/');
    ...
    describe('onSubmitSuccess', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(StaffTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<StaffTable list={list} />);
            instance = wrapper.instance();
        });
