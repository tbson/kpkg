...
import {Row, GroupTable} from '../tables/GroupTable';
import LoadingLabel from 'src/utils/components/LoadingLabel';
import Tools from 'src/utils/helpers/Tools';

Enzyme.groupure({adapter: new Adapter()});
...
describe('GroupTable component', () => {
    ...
    it('Get list', done => {
        ...
        const wrapper = shallow(<GroupTable {...props} />);
        ...
        setTimeout(() => {
            ...
            expect(props.action.mock.calls[0][1]).toEqual({
                data: props.groupState.list,
                pages: props.groupState.pages,
            });
    ...
    it('Add', done => {
        ...
        const toggleModalSpy = jest.spyOn(GroupTable.prototype, 'toggleModal');
    ...
    describe('Bulk remove', () => {
        ...
        it('No check', done => {
            const handleRemoveSpy = jest.spyOn(GroupTable.prototype, 'handleRemove').mockImplementation(() => null);
        ...
        it('Check 1', done => {
            props.groupState.list[0].checked = true;
        ...
        it('Check 3', done => {
            props.groupState.list[0].checked = true;
            props.groupState.list[1].checked = true;
            props.groupState.list[2].checked = true;
    ...
    describe('GroupTable methods', () => {
        ...
        it('list', async () => {
            ...
            const setInitDataSpy = jest.spyOn(GroupTable.prototype, 'setInitData');
            ...
            expect(apiCallSpy.mock.calls[0][0]).toEqual('about:///api/v1/group/');
            ...
            // Default URL
            expect(apiCallSpy).toHaveBeenCalled();
            expect(apiCallSpy.mock.calls[1][0]).toEqual('about:///api/v1/group/');
        ...
        describe('toggleModal', () => {
            it('Not defined modalName or null ID', async () => {
                ...
                jest.spyOn(GroupTable.prototype, 'componentDidMount').mockImplementation(() => {});
                ...
                let wrapper = shallow(<GroupTable {...props} />);
        ...
        it('handleSubmit', async () => {
            ...
            const toggleModal = jest.spyOn(GroupTable.prototype, 'toggleModal')
                .mockImplementation(
                    () => ({}),
                );
            jest.spyOn(GroupTable.prototype, 'componentDidMount').mockImplementation(() => {});
            ...
            const handleAddSuccess = jest.spyOn(GroupTable.prototype, 'handleAdd')
                .mockImplementation(
                    async params => null
                );
            const handleEditSuccess = jest.spyOn(GroupTable.prototype, 'handleEdit')
                .mockImplementation(
                    async params => null
                );
