...
import {Row} from '../tables/PermissionTable';
...
describe('PermissionTable Row component', () => {
    it('Check output value', () => {
        expect(wrapper.contains(<td className="name">name 1</td>)).toEqual(true);
        expect(wrapper.contains(<td className="codename">codename1</td>)).toEqual(true);
    });
...
describe('PermissionTable Row method', () => {
