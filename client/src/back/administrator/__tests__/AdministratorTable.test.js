...
describe('AdministratorTable component', () => {
    beforeAll(() => {
        const response = {
            status: 200,
            success: true,
    ...
    it('Init data', done => {
        const wrapper = shallow(<AdministratorTable />);
    ...
    it('Check all', () => {
        ...
        jest.spyOn(AdministratorTable.prototype, 'componentDidMount').mockImplementation(() => {});

        const wrapper = shallow(<AdministratorTable list={seeding(10)} />);
        const instance = wrapper.instance();
...
describe('AdministratorTable methods', () => {
    beforeEach(() => {
        jest.restoreAllMocks();
    });
    ...
    describe('toggleModal', () => {
        ...
        beforeEach(() => {
            jest.spyOn(AdministratorTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<AdministratorTable />);
    ...
    describe('getList', () => {
        it('fail', async () => {
            ...
            // setInitData will call after AdministratorTable mount
            expect(getList.mock.calls[0][0]).toEqual('http://localhost/api/v1/admin/');
    ...
    describe('onSubmitSuccess', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(AdministratorTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<AdministratorTable list={list} />);
            instance = wrapper.instance();
        });
