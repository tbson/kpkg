...
import {Row} from '../tables/AdministratorTable';
...
describe('AdministratorTable Row component', () => {
    it('Check output value', () => {
        expect(wrapper.contains(<td className="email">email1@gmail.com</td>)).toEqual(true);
        expect(wrapper.contains(<td className="username">username1</td>)).toEqual(true);
        expect(wrapper.contains(<td className="fullname">fullname 1</td>)).toEqual(true);
    });
...
describe('AdministratorTable Row method', () => {
