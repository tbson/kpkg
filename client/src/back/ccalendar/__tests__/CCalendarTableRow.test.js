...
import {Row} from '../tables/CCalendarTable';
...
describe('CCalendarTable Row component', () => {
    it('Check output value', () => {
        ...
        expect(wrapper.contains(<td className="start">24/12/2018</td>)).toEqual(true);
        expect(wrapper.contains(<td className="end">26/12/2018</td>)).toEqual(true);
        expect(wrapper.contains(<td className="url"><a href="url1" target="_blank">url1</a></td>)).toEqual(true);
    });
...
describe('CCalendarTable Row method', () => {
