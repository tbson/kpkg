...
import {Row, BannerTable} from '../tables/BannerTable';
import LoadingLabel from 'src/utils/components/LoadingLabel';
import Tools from 'src/utils/helpers/Tools';

Enzyme.bannerure({adapter: new Adapter()});
...
describe('BannerTable component', () => {
    ...
    it('Get list', done => {
        ...
        const wrapper = shallow(<BannerTable {...props} />);
        ...
        setTimeout(() => {
            ...
            expect(props.action.mock.calls[0][1]).toEqual({
                data: props.bannerState.list,
                pages: props.bannerState.pages,
            });
    ...
    it('Add', done => {
        ...
        const toggleModalSpy = jest.spyOn(BannerTable.prototype, 'toggleModal');
    ...
    describe('Bulk remove', () => {
        ...
        it('No check', done => {
            const handleRemoveSpy = jest.spyOn(BannerTable.prototype, 'handleRemove').mockImplementation(() => null);
        ...
        it('Check 1', done => {
            props.bannerState.list[0].checked = true;
        ...
        it('Check 3', done => {
            props.bannerState.list[0].checked = true;
            props.bannerState.list[1].checked = true;
            props.bannerState.list[2].checked = true;
    ...
    describe('BannerTable methods', () => {
        ...
        it('list', async () => {
            ...
            const setInitDataSpy = jest.spyOn(BannerTable.prototype, 'setInitData');
            ...
            expect(apiCallSpy.mock.calls[0][0]).toEqual('about:///api/v1/banner/');
            ...
            // Default URL
            expect(apiCallSpy).toHaveBeenCalled();
            expect(apiCallSpy.mock.calls[1][0]).toEqual('about:///api/v1/banner/');
        ...
        describe('toggleModal', () => {
            it('Not defined modalName or null ID', async () => {
                ...
                jest.spyOn(BannerTable.prototype, 'componentDidMount').mockImplementation(() => {});
                ...
                let wrapper = shallow(<BannerTable {...props} />);
        ...
        it('handleSubmit', async () => {
            ...
            const toggleModal = jest.spyOn(BannerTable.prototype, 'toggleModal')
                .mockImplementation(
                    () => ({}),
                );
            jest.spyOn(BannerTable.prototype, 'componentDidMount').mockImplementation(() => {});
            ...
            const handleAddSuccess = jest.spyOn(BannerTable.prototype, 'handleAdd')
                .mockImplementation(
                    async params => null
                );
            const handleEditSuccess = jest.spyOn(BannerTable.prototype, 'handleEdit')
                .mockImplementation(
                    async params => null
                );
