...
describe('BannerTable component', () => {
    ...
    it('Init data', done => {
        const wrapper = shallow(<BannerTable match={match} />);
    ...
    it('Check all', () => {
        ...
        const wrapper = shallow(<BannerTable match={match} list={seeding(10)} />);
        const instance = wrapper.instance();
...
describe('BannerTable methods', () => {
    ...
    describe('toggleModal', () => {
        ...
        beforeEach(() => {
            jest.spyOn(BannerTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<BannerTable match={match} />);
    ...
    describe('onSubmitSuccess', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(BannerTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<BannerTable match={match} list={list} />);
            instance = wrapper.instance();
        });
