...
import {Row, TagTable} from '../tables/TagTable';
import LoadingLabel from 'src/utils/components/LoadingLabel';
import Tools from 'src/utils/helpers/Tools';

Enzyme.tagure({adapter: new Adapter()});
...
describe('TagTable component', () => {
    ...
    it('Get list', done => {
        ...
        const wrapper = shallow(<TagTable {...props} />);
        ...
        setTimeout(() => {
            ...
            expect(props.action.mock.calls[0][1]).toEqual({
                data: props.tagState.list,
                pages: props.tagState.pages,
            });
    ...
    it('Add', done => {
        ...
        const toggleModalSpy = jest.spyOn(TagTable.prototype, 'toggleModal');
    ...
    describe('Bulk remove', () => {
        ...
        it('No check', done => {
            const handleRemoveSpy = jest.spyOn(TagTable.prototype, 'handleRemove').mockImplementation(() => null);
        ...
        it('Check 1', done => {
            props.tagState.list[0].checked = true;
        ...
        it('Check 3', done => {
            props.tagState.list[0].checked = true;
            props.tagState.list[1].checked = true;
            props.tagState.list[2].checked = true;
    ...
    describe('TagTable methods', () => {
        ...
        it('list', async () => {
            ...
            const setInitDataSpy = jest.spyOn(TagTable.prototype, 'setInitData');
            ...
            // setInitData will call after TagTable mount
            expect(apiCallSpy).toHaveBeenCalled();
            expect(apiCallSpy.mock.calls[0][0]).toEqual('about:///api/v1/tag/');
            ...
            // Default URL
            expect(apiCallSpy).toHaveBeenCalled();
            expect(apiCallSpy.mock.calls[1][0]).toEqual('about:///api/v1/tag/');
        ...
        describe('toggleModal', () => {
            it('Not defined modalName or null ID', async () => {
                ...
                jest.spyOn(TagTable.prototype, 'componentDidMount').mockImplementation(() => {});
                ...
                let wrapper = shallow(<TagTable {...props} />);
        ...
        it('handleSubmit', async () => {
            ...
            const toggleModal = jest.spyOn(TagTable.prototype, 'toggleModal')
                .mockImplementation(
                    () => ({}),
                );
            jest.spyOn(TagTable.prototype, 'componentDidMount').mockImplementation(() => {});
            ...
            const handleAddSuccess = jest.spyOn(TagTable.prototype, 'handleAdd')
                .mockImplementation(
                    async params => null
                );
            const handleEditSuccess = jest.spyOn(TagTable.prototype, 'handleEdit')
                .mockImplementation(
                    async params => null
                );
