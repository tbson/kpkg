...
describe('TagTable component', () => {
    ...
    it('Init data', done => {
        const wrapper = shallow(<TagTable />);
    ...
    it('Check all', () => {
        ...
        const wrapper = shallow(<TagTable list={seeding(10)} />);
        const instance = wrapper.instance();
...
describe('TagTable methods', () => {
    ...
    describe('getList', () => {
        it('fail', async () => {
            ...
            expect(getList.mock.calls[0][0]).toEqual('http://localhost/api/v1/tag/');
    ...
    describe('onSubmitSuccess', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(TagTable.prototype, 'componentDidMount').mockImplementation(() => {});
            wrapper = shallow(<TagTable list={list} />);
            instance = wrapper.instance();
        });
